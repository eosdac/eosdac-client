export default {
  ...
  'contract_errors': {
    ...
    'COMPLETEWORK_WRONG_STATE': 'Job application can only be completed from work_in_progress state',
    ...
    'FINALIZE_INSUFFICIENT_VOTES': 'Insufficient votes on job application to be finalized.',
    ...
    'PROPOSAL_EXPIRED': 'The job application is expired.',
    ...
    'STARTWORK_INSUFFICIENT_VOTES': 'Insufficient votes on job application.',
  ...
  'dac_financials': {
    ...
    'treasury_explainer': 'The following account has been set up as the treasury account for the DAC.  This account is controlled by the DAC and is designed to hold all of the token balances which are owned by it, the funds here are used to pay for job applications and custodian pay.',
  ...
  'menu': {
    ...
    'my_worker_proposals': 'My Job Applications',
    'new_referendum': 'Propose Referendum',
    'new_worker_proposal': 'New Job Application',
    'profile': 'Profile',
    ...
    'view_worker_proposals': 'Job Board',
    'vote_msigs': 'Management Proposals',
    'vote_worker_proposals': 'Job Board'
  },
  'msig_creator': {
    'actions': 'Actions',
    'advanced': 'advanced',
  ...
  'workerproposals': {
    ...
    'cancelled': 'Cancelled',
    'loading': 'Loading',
    'no_proposals': 'No jobs match the filter',
  ...
  'newworkerproposal': {
    ...
    'intro': 'Please fill in the form to explain your job application.',
  ...
  'contracts_config': {
    ...
    'referendum_allow_vote_type': 'Allow Vote Type',
    ...
    'referendum_duration': 'Referendum duration',
    ...
    'features_wp_contract': 'Job applications contract name',
    'features_referendums': 'Referendums',
    'features_wp': 'Job Applications',
