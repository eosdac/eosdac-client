        ...
        <div class="text-center " style="height:80px">
          ...
          <div v-if="getShowTransactionOverlay == 'sign'">
            <q-icon
              ...
              size="50px"
            />
            <div class=" text-primary animate-fade" style="height:25px">
              {{ $t("transaction.waiting_for_signature") }}
            </div>
            <div
              v-if="getSettingByName('trx_delay').value"
              class="q-caption text-warning"
            >
          ...
          <div v-if="getShowTransactionOverlay == 'success'">
            <q-icon
              ...
              size="70px"
            />
            <div class=" text-positive animate-fade" style="height:50px">
          ...
          <div v-if="getShowTransactionOverlay == 'cancelled'">
            <q-icon
              ...
              size="70px"
            />
            <div class=" text-negative animate-fade" style="height:50px">
